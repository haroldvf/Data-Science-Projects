...
app.layout = html.Div([
    ...
    html.Div([
        ...
        dcc.Dropdown(
            ...
            value='Select Year',
            placeholder='Select', style={'width': '80%', 'padding': '3px', 'font-size': '20px', 'text-align-last': 'center'}
        )
    ]),
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        ...
        R_chart4 = dcc.Graph(figure=px.bar(unemployment_effect, x='unemployment_rate', y='Automobile_Sales', labels={'unemployment_rate': 'Unemployment Rate', 'Automobile_Sales': 'Average Automobile Sales'}, title='Effect of Unemployment Rate on Vehicle Type and Sales'))
